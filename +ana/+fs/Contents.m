% File-system tools.
%
% <a href="matlab:help ana.fs.path">path</a> - Canonical representation of a file path or URL.
% <a href="matlab:help ana.fs.path.separator">path.separator</a> - Canonical path separator.
%
% Details
% 
